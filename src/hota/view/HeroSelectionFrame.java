...
/**
 * HeroSelectionFrame
 * Opening screen — player picks a name and hero class, then enters the arena.
 * Opponent is always the Warrior first (progression: Warrior → Mage → Archer).
 */
public class HeroSelectionFrame extends JFrame {
    ...
    private JPanel buildPanel() {
        ...
        progressionLabel = new JLabel(
                "Progression:  Warrior  →  Mage  →  Archer", SwingConstants.CENTER);
        ...
        infoLabel = new JLabel(
                "Your first opponent will always be a Warrior.", SwingConstants.CENTER);
        ...
        startBtn.addActionListener(e -> {
            ...
            // First opponent is always a Warrior
